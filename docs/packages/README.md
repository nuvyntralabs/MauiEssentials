...
| Lumina MAUI UI kit (`NV*` controls and page recipes, basics → advanced + 1.2 / 1.3 chrome). Hub module; not a `Plugin.Maui.*` package. 1.4.0 catalog (deepened 1.0 types). | NuvyntraLabs.UIKit | https://www.nuget.org/packages/NuvyntraLabs.UIKit | https://github.com/nuvyntralabs/NuvyntraLabs.UIKit |
