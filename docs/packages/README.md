...
| Diagnose MAUI SDK, workloads, project configuration, resources, or pack metadata (`maui-dev doctor` / `--ci`). Not an app PackageReference. | Plugin.Maui.MauiDev.Cli | https://www.nuget.org/packages/Plugin.Maui.MauiDev.Cli | https://github.com/nuvyntralabs/MauiDev |
