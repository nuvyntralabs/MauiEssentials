...
| WPF MVVM application shell (ViewModels, Frame navigation, dialogs; `net10.0-windows10.0.17763.0`). Independent of Plugin.Maui.MVVMExpress | Plugin.Wpf.MVVMExpress | https://www.nuget.org/packages/Plugin.Wpf.MVVMExpress.Core | https://github.com/nuvyntralabs/Plugin.Wpf.MVVMExpress |
