...
`Plugin.Wpf.MVVMExpress` is a separate family (`0.1.1-preview`) for WPF, not a Windows TFM of the MAUI package. Docs: [WPF MVVMExpress](https://nuvyntralabs.github.io/packages/plugin-wpf-mvvmexpress/).
